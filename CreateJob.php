...
<table align="center" border="1" width="60%" height="80%">

	<th colspan="2" style="font-size:30px;font-weight:bold;text-shadow: 2px 2px white;background-color:#b0e0e6;padding:5px;color: #0055CC;">Add a New Job for Placement	</th>
	<tr>
	<td><div class="labl">Job ID: </div></td>
	<td><input type="string" name="JobID" style="width:200px;height:25px;"></td>
	</tr>
	<tr>
	<td><div class="labl">Job Description: </div></td>
	<td><input type="string" name="JobDesc" style="width:450px;height:30px;"></td>
	</tr>
	<tr>
	<td><div class="labl">Company Name: </div></td>
	<td><input type="string" name="Company" style="width:450px;height:30px"></td>
	</tr>
	<tr>
	<td><div class="labl">Post Date: </div></td>
	<td><input type="date" name="PostDate" value=<?php echo date('d-m-y');?>>
	</td>
	</tr>
	<tr>
	...
	<td><input type="string" name="oreq" style="width:450px;height:30px;"></td>
	</tr>
	<tr>
	<td><div class="labl">Salary Package: </div></td>
	<td><input type="string" name="salPack" style="width:200px;height:25px;"></td>
	</tr>
	<tr>
	<td><div class="labl">Location: </div></td>
	<td><input type="string" name="Loc" style="width:450px;height:30px;" ></td>
	</tr>
